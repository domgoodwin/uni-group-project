class Killed extends Phaser.State {
    ...
    create(in_rooms) {
        ...
        var text = this.game.add.text(this.game.world.centerX, this.game.world.centerY, "You fell into a hidden abyss! Game Over!", {font: "48px Verdana", fill: "#ffffff", align: "center"});  
        text.anchor.set(0.5);
        text.stroke = "#000000";
