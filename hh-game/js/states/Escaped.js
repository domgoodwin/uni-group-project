class Escaped extends Phaser.State {
    ...
    create(in_rooms) {
        ...
        var text = this.game.add.text(this.game.world.centerX, this.game.world.centerY, "You digged a tunnel and escaped! Congratulations!", {font: "48px Verdana", fill: "#ffffff", align: "center"}); 
        text.anchor.set(0.5);
        text.stroke = "#000000";
