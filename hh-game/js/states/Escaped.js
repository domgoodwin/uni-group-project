class Escaped extends Phaser.State {
    ...
    create(in_rooms) {
        ...
        var text = this.game.add.text(this.game.world.centerX, this.game.world.centerY-100, "Congratulations!", {font: "48px Verdana", fill: "#ffffff", align: "center"}); 
        text.anchor.set(0.5);
        text.stroke = "#000000";
        text.strokeThickness = 8;
        var text1 = this.game.add.text(this.game.world.centerX, this.game.world.centerY, "You digged a tunnel and escaped!!", {font: "20px Verdana", fill: "#ffffff", align: "center"}); 
        text1.anchor.set(0.5);
        text1.stroke = "#000000";
        text1.strokeThickness = 8;
        var text2 = this.game.add.text(this.game.world.centerX, this.game.world.centerY+50, "Score: "+score, {font: "20px Verdana", fill: "#ffffff", align: "center"}); 
        text2.anchor.set(0.5);
        text2.stroke = "#000000";
        text2.strokeThickness = 8;
        var text3 = this.game.add.text(this.game.world.centerX, this.game.world.centerY+100, "Settings: "+mode+" / "+random, {font: "20px Verdana", fill: "#ffffff", align: "center"}); 
